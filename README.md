...
[![CI](https://github.com/FederCO23/FedeNet/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/FederCO23/FedeNet/actions/workflows/ci.yml)
[![lint: ruff](https://img.shields.io/badge/lint-ruff-blue?logo=ruff&logoColor=white&style=flat-square)](https://docs.astral.sh/ruff/)
[![types: mypy](https://img.shields.io/badge/types-mypy-4B8BBE?logo=python&logoColor=white&style=flat-square)](http://mypy-lang.org/)
[![tests: pytest](https://img.shields.io/badge/tests-pytest-0A9EDC?logo=pytest&logoColor=white&style=flat-square)](https://docs.pytest.org/)
